  ...
  <div class="layout">
    <Layout>
      <Sider ref="side1" hide-trigger collapsible :collapsed-width="80" v-model="isCollapsed" style="overflow-y: auto">
        <div class="layout-logo-left" :style="isCollapsed ? 'font-size:12px': ''">轻企云官网</div>
        <Menu
          :accordion="true"
          width="auto"
      ...
      <Layout>
        <div class="fixed-box">
          <Header :style="{padding: 0}" class="layout-header-bar">
            ...
            <div style="float: right;margin-right: 25px" v-if="adminAuth">
              <Dropdown transfer trigger="click" @on-click="exitAccount">
                <a href="javascript:void(0)">
                  <span class="main-user-name">{{adminAuth.nickname}}</span>
